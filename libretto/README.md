...
- workspace scan summary for the selected issue when backend security scanning is enabled
...
- focused SCM sources now move to the top of the source list during investigation
